...
/*
	Imitate
	curl -X POST \
  	https://staging.open-diksha.org/api/api-manager/v1/consumer/mobile_app_openrap/credential/register \
...
let registerDikshaApp = () => {
	...
	let callableUrl = 'https://staging.open-diksha.org/api/api-manager/v1/consumer/mobile_app_openrap/credential/register'
	let headers = {
...
/*
	Must mimic
	curl -X POST \
  https://staging.open-diksha.org/api/api-manager/v1/consumer/mobile_device_openrap/credential/register \
...
let registerdikshaDevice = (token) => {
	...
	const pattern = 'YYYY-MM-DD HH:mm:ss:SSSZZ';
	const timestamp = getTimestamp(pattern);
	let callableUrl = 'https://staging.open-diksha.org/api/api-manager/v1/consumer/mobile_device_openrap/credential/register'
	let headers = {
